...
#SBATCH --mem 245GB
#SBATCH -o /shared/projects/oran_lake_meta/results/diamond/slurm_sample.%N.%j.out
#SBATCH -e /shared/projects/oran_lake_meta/results/diamond/slurm_sample.%N.%j.err
